...
const SchedulePage = lazy(() => import('./pages/workspace/SchedulePage').then((m) => ({ default: m.SchedulePage })));
const ClientsPage = lazy(() => import('./pages/workspace/ClientsPage').then((m) => ({ default: m.ClientsPage })));
const ClientDetailPage = lazy(() => import('./pages/workspace/ClientDetailPage').then((m) => ({ default: m.ClientDetailPage })));
const AnalyticsPage = lazy(() => import('./pages/workspace/AnalyticsPage').then((m) => ({ default: m.AnalyticsPage })));
const BrandSettingsPage = lazy(() => import('./pages/workspace/settings/BrandSettingsPage').then((m) => ({ default: m.BrandSettingsPage })));
const TeamSettingsPage = lazy(() => import('./pages/workspace/settings/TeamSettingsPage').then((m) => ({ default: m.TeamSettingsPage })));
const SubscriptionSettingsPage = lazy(() => import('./pages/workspace/settings/SubscriptionSettingsPage').then((m) => ({ default: m.SubscriptionSettingsPage })));
const PayoutSettingsPage = lazy(() => import('./pages/workspace/settings/PayoutSettingsPage').then((m) => ({ default: m.PayoutSettingsPage })));
const FormsManagerPage = lazy(() => import('./pages/workspace/settings/FormsManagerPage').then((m) => ({ default: m.FormsManagerPage })));
const FormEditorPage = lazy(() => import('./pages/workspace/settings/FormEditorPage').then((m) => ({ default: m.FormEditorPage })));
const DiscountSettingsPage = lazy(() => import('./pages/workspace/settings/DiscountSettingsPage').then((m) => ({ default: m.DiscountSettingsPage })));
const TelehealthVideoRoomPage = lazy(() => import('./pages/workspace/TelehealthVideoRoomPage').then((m) => ({ default: m.TelehealthVideoRoomPage })));
const SessionPrepPage = lazy(() => import('./pages/workspace/SessionPrepPage').then((m) => ({ default: m.SessionPrepPage })));
const ClientPortalPage = lazy(() => import('./pages/portal/ClientPortalPage').then((m) => ({ default: m.ClientPortalPage })));
const OnboardingWizardPage = lazy(() => import('./pages/workspace/OnboardingWizardPage').then((m) => ({ default: m.OnboardingWizardPage })));
...
const NotificationsPage = lazy(() => import('./pages/workspace/NotificationsPage').then((m) => ({ default: m.NotificationsPage })));
const SubmissionsPage = lazy(() => import('./pages/workspace/SubmissionsPage').then((m) => ({ default: m.SubmissionsPage })));
const AvailabilitySettingsPage = lazy(() => import('./pages/workspace/settings/AvailabilitySettingsPage').then((m) => ({ default: m.AvailabilitySettingsPage })));
const MyProfilePage = lazy(() => import('./pages/workspace/MyProfilePage').then((m) => ({ default: m.MyProfilePage })));
const AccountPreferencesPage = lazy(() => import('./pages/workspace/settings/AccountPreferencesPage').then((m) => ({ default: m.AccountPreferencesPage })));
const PracticeProfilePage = lazy(() => import('./pages/workspace/settings/PracticeProfilePage').then((m) => ({ default: m.PracticeProfilePage })));
